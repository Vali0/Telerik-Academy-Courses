...
namespace Task01ConnectToNorthwind
{
    ...
    public partial class NorthwindDatabase : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<double>> usp_FindTotalIncomesByGivenNameAndPeriod(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<double>>("usp_FindTotalIncomesByGivenNameAndPeriod", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
