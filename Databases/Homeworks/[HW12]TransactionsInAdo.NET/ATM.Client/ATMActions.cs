...
namespace ATM.Client
{
    ...
    {
        public static bool WithdrawMoney(int PIN, int cardNumber, decimal moneyToWithdraw, AtmDatabase db)
        {
            bool success = true;
        ...
        public static void RecordWithdrawal(int cardNumber, decimal ammount, AtmDatabase db)
        {
            ...
            {
                db.TransactionsHistory.Add(new TransactHistory()
                {
