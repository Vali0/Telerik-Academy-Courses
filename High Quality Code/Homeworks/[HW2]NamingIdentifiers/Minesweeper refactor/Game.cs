    ...
    public class Game
    {
        ...
        private static void PrintHelp()
        {
            Console.WriteLine(
                              ...
                              "Clear the minefield without detonating a mine.\nCommands:\n" +
        ...
        {
            Console.WriteLine("Minesweeper Version 1.0.0\nMade in Soviet Union 2014.\nGoodbye");
        }
        ...
        private static void PrintTopResults(List<Points> results)
        {
            Console.WriteLine("\nTop results:");
        ...
        private static void Main()
        {
            ...
            List<Points> topResults = new List<Points>(TopResultsToKeep);
            ...
            do
            {
                ...
                if (explosion)
                {
                    ...
                    Console.Write("\nYou've just hit a mine! Your score: {0} points. ", score);

                    Console.Write("Your nickname: ");
                    string nickname = Console.ReadLine();
                    Points result = new Points(nickname, score);
                    ...
                    topResults.Sort((Points r1, Points r2) => r2.Name.CompareTo(r1.Name));
                    topResults.Sort((Points r1, Points r2) => r2.Score.CompareTo(r1.Score));
                    PrintTopResults(topResults);
